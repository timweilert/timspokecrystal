...
BonnieAnimation:    INCLUDE "gfx/pokemon/bonnie/anim.asm"
BuffwuffAnimation:   INCLUDE "gfx/pokemon/buffwuff/anim.asm"
...
PuppogusAnimation:      INCLUDE "gfx/pokemon/puppogus/anim.asm"
WoofagusAnimation:     INCLUDE "gfx/pokemon/woofagus/anim.asm"
