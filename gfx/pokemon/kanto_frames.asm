...
BonnieFrames:    INCLUDE "gfx/pokemon/bonnie/frames.asm"
BuffwuffFrames:   INCLUDE "gfx/pokemon/buffwuff/frames.asm"
...
PuppogusFrames:      INCLUDE "gfx/pokemon/puppogus/frames.asm"
WoofagusFrames:     INCLUDE "gfx/pokemon/woofagus/frames.asm"
