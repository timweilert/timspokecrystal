...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, BONNIE, GOLDUCK, WOOFAGUS, GOLEM, GRAVELER, VENONAT, -1
...
.su_zu:    db SUICUNE, STARMIE, SCYTHER, PUPPOGUS, BEEDRILL, HYPNO, DROWZEE, -1
...
.ra:       db RAIKOU, RAICHU, CHANSEY, BUFFWUFF, LAPRAS, VILEPLUME, LANTURN, -1
