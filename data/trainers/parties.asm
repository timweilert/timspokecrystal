...
Rival1Group:
	...
	db 20, PUPPOGUS,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, WOOFAGUS,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	...
	db 36, WOOFAGUS,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
...
ErikaGroup:
	...
	db 42, TANGELA,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_SPORES
...
YoungsterGroup:
	...
	db 21, BUFFWUFF,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, BUFFWUFF,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, BUFFWUFF,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 37, VILEPLUME,  SOLARBEAM, SLEEP_SPORES, ACID, MOONLIGHT
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, BULBASAUR,  LEECH_SEED, POISONPOWDER, SLEEP_SPORES, RAZOR_LEAF
	db -1 ; end
	...
	db 31, EXEGGCUTE,  LEECH_SEED, CONFUSION, SLEEP_SPORES, SOLARBEAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, VENUSAUR,   BODY_SLAM, SLEEP_SPORES, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25, BUTTERFREE, CONFUSION, SLEEP_SPORES, WHIRLWIND, GUST
...
BugCatcherGroup:
	...
	db 24, BUTTERFREE, CONFUSION, SLEEP_SPORES, SUPERSONIC, WHIRLWIND
	db -1 ; end
	...
	db 34, BUTTERFREE, PSYBEAM, SLEEP_SPORES, GUST, WHIRLWIND
	db -1 ; end
...
Rival2Group:
	...
	db 42, WOOFAGUS,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
...
PicnickerGroup:
	...
	db 30, WEEPINBELL, SLEEP_SPORES, POISONPOWDER, STUN_SPORE, SLUDGE_BOMB
	...
	db 33, JUMPLUFF,   SUNNY_DAY, SLEEP_SPORES, LEECH_SEED, COTTON_SPORE
...
ExecutiveFGroup:
	...
	db 32, VILEPLUME,  ABSORB, SWEET_SCENT, SLEEP_SPORES, ACID
	...
	db 23, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_SPORES, ACID
...
GruntFGroup:
	...
	db 18, GLOOM,      ABSORB, SWEET_SCENT, STUN_SPORE, SLEEP_SPORES
	db -1 ; end
