...
GruntM28Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_BUFFWUFF_TAIL
	end
...
.Script:
	...
	checkevent EVENT_LEARNED_BUFFWUFF_TAIL
	iffalse .NeedsPassword
	sjump .OpenSesame
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  5, 14, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, BuffwuffTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
